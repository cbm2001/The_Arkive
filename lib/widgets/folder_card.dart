...
class FolderCardState extends State<FolderCard> {
  ...
  addpost(String folderId, String postId) async {
    try {
      await _folder.addPostToFolder(folderId, postId);
    } catch (err) {
      showSnackBar(
        context,
        err.toString(),
  ...
  adduser(String folderId, String uid, String username) async {
    try {
      ...
      await _folder.addUserToFolder(folderId, uid, username);
    } catch (err) {
      showSnackBar(
        context,
        err.toString(),
  ...
  deletepost(String folderId, String postId) {
    try {
      _folder.removePostFromFolder(folderId, postId);
    } catch (err) {
      showSnackBar(
        context,
        err.toString(),
  ...
  deleteuser(String folderId, String uid, String username) {
    try {
      _folder.removeUserFromFolder(folderId, uid, username);
    } catch (err) {
      showSnackBar(
        context,
        err.toString(),
